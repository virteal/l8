...
promises and distributed actors. Such tasks can run browser side or server side.
...
This is a library to help those who want to embrace the javascript style of asynchronous programming but feel that the classic thread/blocking-function model is also very readable.
...
manner. See the test/node.js working example.
