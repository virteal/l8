...
var Parole = (function(){
  ...
  P.toString = function(){
    return "[" + this.state() + " object Parole]";
  };
  ...
  P._fork_step = _fork_step; function _fork_step(){
    var values = this.previous.values = arguments;
    var forks = this.previous._fork;
  ...
  P.nor = nor; function nor(){
    if( !this || !this.promises ){
      return (this || P).each( nor, arguments );
    }
    if( this.error  ) return this;
    if( !this.value ){
      this.value = true;
