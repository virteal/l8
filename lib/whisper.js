...
var Parole = (function(){
  ...
  // ToDo: I could change Function's prototype, ugly but fast
  ...
  var _set_proto = has_proto
  ? function( obj ){ obj.__proto__ = P; }
  : function( obj ){
    // Copy inherited methods, very slow
    for( var property in P ){
      if( !proto.hasOwnProperty( property ) )continue;
      obj[ property ] = P[ property ];
    }
  };
  // Compile slightly more efficient _set_proto, still very slow
  if( !has_proto ){
  ...
  // Use __noSuchMethod__ on firefox
