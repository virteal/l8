...
// Define the "node.js server" actor. There is "node.js client" peer actor in
// the client side stage.
var ApiServer = l8.Actor( "node server", actor_queried )
  ...
  // in the remote caller's context, instead of locally
    return function(){
      ...
      args[ args.length - 1 ] = function(){
        ...
        client.send( [ cb._node_client_oid ].concat( args ) )
      }
