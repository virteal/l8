...
(function(){
  ...
  water.success = function( v ){
    return (v && ( !v.water )) || typeof v !== "undefined";
  };
  ...
  water.end     = function( v ){
    return v && v.water && v.error === water.end;
  };
  ...
  MakeFluid.use = function( x ){
    for( var key in x ){
      if( x.hasOwnProperty( key ) ){
        Fluid.prototype.key = x.key;
      }
    }
    return MakeFluid;
  };
  MakeFluid.prototype = Fluid.prototype;
